/*
https://app.codesignal.com/arcade/db/selecting-what-to-select/xGydzHseQM8Jcoeew
...
BEGIN
    ...
    (
	SELECT id, 'name' as column_name, name as value, '1' as odr
    FROM workers_info
    UNION 
    SELECT id, 'date_of_birth' as column_name, date_of_birth as value, '2' as odr
    FROM workers_info
    UNION
    SELECT id, 'salary' as column_name, salary as value, '3' as odr
    FROM workers_info
    ORDER BY id, odr
    ) b
