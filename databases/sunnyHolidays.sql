/*
https://app.codesignal.com/arcade/db/selecting-what-to-select/TTcpS2rcPYsC3HZq2
...
BEGIN
	SELECT holiday_date ski_date FROM holidays h
    WHERE EXISTS (SELECT * FROM weather w WHERE h.holiday_date = w.sunny_date);
END
