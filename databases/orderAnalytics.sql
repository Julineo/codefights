/*
https://app.codesignal.com/arcade/db/express-your-creativity/uk2oaFYGfFzb4u3XX
...
BEGIN
    ...
    CREATE TEMPORARY TABLE order_analytics
    SELECT id, YEAR(order_date) year, QUARTER(order_date) quarter,
    type, quantity * price AS total_price
    FROM orders;
